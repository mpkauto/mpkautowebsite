  ...
  return (
    <div className="min-h-screen bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
      <Helmet>
        ...
        <meta
          name="description"
          content="Book your AC service appointment with MPK Auto Service. Professional AC repair and maintenance services for all vehicle makes and models."
        />
      </Helmet>
        ...
        {isSubmitted ? (
          ...
          >
            ...
            <p className="text-base text-brand-contrastText mb-6">
              Thank you for booking with MPK Auto Service. We'll contact you shortly to confirm your
              appointment.
            </p>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                {errors.name && (
                  <p className="text-base text-brand-contrastText mt-1 text-red-500">
                    {errors.name.message}
                  </p>
                )}
              </div>
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0">
                    <Calendar
                      ...
                      onSelect={(date) =>
                        date && setValue('preferredDate', date.toISOString().split('T')[0])
                      }
