  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Careers at MPK | Join Our Auto AC Service Team" />
        <meta
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-300 mb-6 max-w-2xl mx-auto">
              We are always looking for skilled and passionate individuals to join the MPK Auto
              Service family.
            </p>
          </div>

          <div className="mb-12">
            <h2 className="text-4xl font-semibold text-gray-900 mb-6">Current Openings</h2>
            ...
            <ScrollAnimation variant="fadeUp" delay={0.1}>
              <div className="bg-gray-800 p-8 rounded-lg shadow-md">
                ...
                <p className="text-base text-gray-300 mb-4">
                  As an AC Technician, you will be responsible for diagnosing, repairing, and
                  maintaining automotive air conditioning systems.
                </p>
            ...
            <ScrollAnimation variant="fadeUp" delay={0.2}>
              <div className="bg-gray-800 p-8 rounded-lg shadow-md">
                ...
                <p className="text-base text-gray-300 mb-2">Full-time</p>
                <p className="text-base text-gray-300 mb-4">
                  Our Service Advisors are the first point of contact for customers, providing
                  excellent service and technical advice.
                </p>
                <p className="text-base text-gray-900 font-semibold">Requirements:</p>
                <ul className="list-disc list-inside text-base text-gray-300 ml-2 mb-2">
                  <li>
                    Previous experience in a service advisor role or automotive customer service.
                  </li>
          ...
          <div className="mt-12 text-center">
            <h2 className="text-4xl font-semibold text-gray-900 mb-6">How to Apply</h2>
            <p className="text-base text-gray-300 mb-6">
              Interested candidates are invited to submit their resume and cover letter to our email
              address or apply through the form below.
            </p>
          </div>

          <div className="bg-ice-white rounded-lg p-8 shadow-md">
            <h2 className="text-4xl font-semibold text-gray-900 mb-6">Application Form</h2>
            <p className="text-base text-gray-300 mb-6">
              Interested in joining our team? Fill out the application form below, and we'll be in
              touch if your qualifications match our needs.
            </p>
