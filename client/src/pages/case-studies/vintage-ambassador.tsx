          ...
          <div className="grid gap-16">
            ...
            <ScrollAnimation variant="fadeUp">
              <div>
                ...
                <p className="text-base text-gray-300 leading-relaxed">
                  The AC unit of a classic Hindustan Ambassador had deteriorated over time, unable to handle Chennai's humid conditions. 
                  Restoring it demanded both technical expertise and respect for the vehicle's heritage.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation variant="fadeUp" delay={0.2}>
              <div>
                ...
                <p className="text-base text-gray-300 leading-relaxed">
                  MPK Auto AC Services meticulously diagnosed and restored the car's original air conditioning system, 
                  preserving its vintage character while delivering modern cooling comfort. Every component was either 
                  reconditioned or precisely replaced to match the Ambassador's original design specs.
                </p>
              </div>
            </ScrollAnimation>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-base text-gray-300">AC restored without compromising authenticity</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-6 w-6 text-gray-300 flex-shrink-0 mt-1" />
                    <span className="text-base text-gray-300">Consistent cabin cooling despite tropical heat</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-6 w-6 text-gray-300 flex-shrink-0 mt-1" />
                    <span className="text-base text-gray-300">A seamless blend of vintage aesthetics and modern performance</span>
                  </li>
                </ul>
              </div>
            </ScrollAnimation>
