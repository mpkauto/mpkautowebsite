          ...
          <div className="grid gap-16">
            ...
            <ScrollAnimation variant="fadeUp">
              <div>
                ...
                <p className="text-base text-gray-300 leading-relaxed">
                  High-frequency usage of Ola cab fleets in Chennai's tropical climate led to recurring AC failures, 
                  impacting driver comfort and customer satisfaction.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation variant="fadeUp" delay={0.2}>
              <div>
                ...
                <p className="text-base text-gray-300 leading-relaxed">
                  MPK Auto AC Services conducted rapid diagnostics and delivered same-day AC repairs across a fleet of 30+ Ola cabs. 
                  Our mobile service teams ensured minimal downtime, restoring optimal cooling performance and enabling uninterrupted 
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-base text-gray-300">Restored 100% AC functionality in all vehicles within 48 hours</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-6 w-6 text-gray-300 flex-shrink-0 mt-1" />
                    <span className="text-base text-gray-300">Reduced vehicle downtime by over 70%</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-6 w-6 text-gray-300 flex-shrink-0 mt-1" />
                    <span className="text-base text-gray-300">Improved Ola driver ratings through enhanced passenger comfort</span>
                  </li>
                </ul>
              </div>
            </ScrollAnimation>
