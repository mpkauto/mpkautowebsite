import { Wind, Wrench, Fan, Gauge, Droplets, Settings, ChevronRight, Hammer, Stethoscope, ClipboardCheck, ArrowRight } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Professional installation of new air conditioning systems for all vehicle makes and models.",
    ...
    {
      title: "AC Repair",
      description: "Expert repair services to fix leaks, compressor issues, and restore optimal cooling performance.",
    ...
    {
      title: "Diagnostics",
      description: "Comprehensive system diagnostics to identify issues and recommend appropriate solutions.",
    ...
    },
    {
      ...
      description: "Professional refrigerant recharge and leak detection services to restore cooling performance.",
    ...
    },
    {
      ...
      description: "Regular maintenance services to prevent issues and extend your AC system's lifespan.",
      ...
      <div className="container mx-auto max-w-[1440px] px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-[#739bd4] font-medium uppercase tracking-wider text-sm">Our Services</span>
          ...
          <p className="text-base text-gray-300 leading-relaxed max-w-2xl mx-auto mb-6">
            Professional services to keep your vehicle's climate control system running at peak performance.
          </p>
