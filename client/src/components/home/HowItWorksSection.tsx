...
export default function HowItWorksSection() {
  ...
  const hoverVariants = {
    hover: () => ({ // Simplified custom prop as last step styling is removed
      y: -10,
      scale: 1.03,
      transition: {
        type: "spring",
  ...
  return (
    <section className="py-20 px-6 md:px-12 bg-gray-900 relative overflow-hidden"> {/* Adjusted padding, removed background pattern */}
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center mb-5"> {/* Keep small separator lines */}
            <div className="h-0.5 w-12 bg-metallic mr-4"></div>
            <span className="text-brand-contrastText font-medium uppercase tracking-wider text-sm">Simple Process</span> {/* Adjusted text color */}
            <div className="h-0.5 w-12 bg-metallic ml-4"></div>
          </div>
          
          <h2 className="text-4xl font-semibold tracking-tight relative mb-6"> {/* Applied H2 style and spacing, removed bold and unnecessary classes */}
            How It Works
          </h2>
          <p className="text-base text-brand-contrastText max-w-2xl mx-auto mb-6"> {/* Applied P style and spacing, adjusted text color */}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-2xl font-medium mb-6 text-white">{step.title}</h3> {/* Applied H3 style and spacing, adjusted text color */}
                  <p className="text-base text-brand-contrastText">{step.description}</p> {/* Applied P style and text color */}
