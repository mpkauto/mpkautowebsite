...
export default function AboutSection() {
  const features = [
    ...
    },
    {
      ...
      description: "Our team is fully certified and continuously trained on the latest AC technologies."
    },
    {
          ...
          <div>
            ...
            <ScrollAnimation variant="fadeUp">
              <div className="relative rounded-2xl overflow-hidden gradient-border">
                ...
                {/* Stats overlay */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/95 to-background/20 p-6 backdrop-blur-sm" ref={ref}>
          ...
          <div>
            ...
            <ScrollAnimation variant="fadeUp">
              <div className="flex items-center mb-5">
                ...
                <span className="text-primary font-medium uppercase tracking-wider text-sm">About MPK</span>
              </div>
              ...
              <p className="font-body text-muted-foreground text-lg mb-8 leading-relaxed">
                With over 15 years of experience, our certified technicians provide expert auto air conditioning services for all makes and models.
              </p>
