  ...
  const caseStudies = [
    {
      ...
      description:
        'Provided rapid diagnostics and repair for over 30 Ola cabs operating in Chennai, minimizing downtime and maximizing driver earnings.',
      category: 'Fleet',
      brand: 'Ola',
    ...
    },
    {
      ...
      description:
        "Lovingly restored the original AC unit of a classic Hindustan Ambassador, ensuring comfortable rides even in Chennai's humid climate.",
      category: 'Vintage',
      brand: 'Hindustan',
    ...
    },
    {
      ...
      description:
        'Performed a complete overhaul of the AC system in a large tour bus operating trips from Chennai, ensuring passenger comfort on long journeys.',
      category: 'Commercial',
      brand: 'Tour Bus',
            ...
            >
              <Link href={study.link} className="block h-full">
                ...
                <div className="p-6 flex-grow flex flex-col justify-between">
                  ...
                  <h3 className="text-2xl font-medium text-white mb-3">{study.title}</h3>
                  <p className="text-base text-brand-contrastText mb-6">{study.description}</p>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center mt-6">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="mt-1 font-semibold text-white">
                        {study.stats.vehicles || study.stats.year}
                      </span>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="mt-1 font-semibold text-white">
                        {study.stats.timeFrame || study.stats.condition}
                      </span>
