      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <motion.div initial="hidden" animate="visible" variants={staggerVariants}>
          ...
          <motion.p
            ...
            variants={contentVariants}
          >
            Expert automotive climate control solutions with industry-leading diagnostics and
            premium repairs for all vehicle makes and models.
          </motion.p>
          ...
          >
            <motion.div variants={contentVariants}>
              {' '}
              {/* Wrap buttons in motion.div for staggering */}
              <Button
                variant="default"
                size="lg"
                shape="circle"
