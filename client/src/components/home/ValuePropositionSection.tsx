  ...
  const valueProps = [
    {
      ...
      description:
        'All our services come with a satisfaction guarantee and warranty on parts and labor.',
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
        <ScrollAnimation variant="fadeUp" className="text-center mb-12">
          ...
          <p className="text-base text-brand-contrastText max-w-2xl mx-auto mb-6">
            Experience premium auto AC service backed by expertise, transparency, and customer
            satisfaction.
          </p>
        </ScrollAnimation>
