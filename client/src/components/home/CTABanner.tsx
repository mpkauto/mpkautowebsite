            ...
            >
              <motion.div className="flex-1" variants={itemVariants}>
                <div className="flex items-center mb-6">
                  ...
                  <span className="text-frost font-medium uppercase tracking-wider text-sm">Schedule Now</span>
                </div>
              ...
              >
                <div className="bg-black/50 backdrop-blur-sm p-8 rounded-xl border border-metallic/20 shadow-xl">
                  <div className="text-center">
                    ...
                    <p className="bg-white/10 text-[#D4D4D4] text-xs uppercase px-2 py-1 rounded-full inline-block mb-4">Limited Time Offer</p>
                    ...
                    <Link href="/services/ac-inspection">
                      <Button 
                        className="bg-frost text-black font-body font-semibold px-6 py-3 rounded-md hover:brightness-110 transition w-full mt-4"
                      >
                        Learn More
                        <ArrowRight className="ml-2 h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
                      </Button>
