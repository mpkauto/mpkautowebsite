...
export default function SymptomsSection() {
  ...
  const symptoms = [
    ...
    },
    {
      ...
      description: "Regular clicking noises when the AC is turned on could indicate a failing compressor clutch.",
    ...
    },
    {
      ...
      description: "Temperature fluctuations or varying cooling performance across different vents.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center mb-5">
              ...
              <span className="text-white/60 font-medium uppercase tracking-wider text-sm">Problem Recognition</span>
            </div>
