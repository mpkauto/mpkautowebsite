  ...
  return (
    <section className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto">
        <h2 className="text-4xl font-semibold mb-6 text-center text-gray-900">Trusted by Leading Brands</h2>
        ...
        <div className="mt-16 max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="text-gray-700 font-medium uppercase tracking-wider text-sm">Service Areas</span>
            ...
            <p className="text-base text-gray-700 mb-6">Mobile AC service available in these areas</p>
          </div>
            ...
            <div className="bg-gray-100 rounded-xl p-6 shadow-sm">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-base text-gray-700">
                  <span className="font-medium text-gray-900">Note:</span> We offer mobile service within a 15-mile radius of our main location. Contact us to confirm coverage for your area.
                </p>
              </div>
            </div>
          </div>
