  ...
  const faqs = [
    {
      ...
      answer: "We provide comprehensive auto AC services including diagnostics, refrigerant recharging, leak detection and repair, compressor replacement, condenser and evaporator repair, and complete system overhauls. Our certified technicians are trained to work on all vehicle makes and models."
    },
    {
      question: "How long does an AC service typically take?",
      answer: "Most standard AC services like refrigerant recharging or basic diagnostics can be completed within 1-2 hours. More complex repairs such as compressor replacement may take 3-4 hours. We pride ourselves on our quick turnaround times, with 95% of services completed same-day."
    },
    {
    ...
    },
    {
      ...
      answer: "We recommend having your car's AC system checked at least once a year, ideally before summer begins. Regular maintenance helps prevent major issues, ensures optimal cooling performance, and can extend the life of your AC components."
    },
    {
      question: "What are signs that my car's AC needs servicing?",
      answer: "Common signs include weak airflow, air not cooling properly, unusual noises when the AC is running, strange odors from the vents, and water leaking inside the vehicle. If you notice any of these symptoms, it's best to have your system checked promptly to prevent more serious damage."
    },
    {
      question: "Do you provide warranty on your AC repair services?",
      answer: "Yes, all our AC repair services come with a 12-month warranty covering both parts and labor. This ensures your peace of mind and reflects our confidence in the quality of our workmanship and the parts we use."
    }
  ];
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-6">
          <div className="flex items-center justify-center mb-5">
            ...
            <span className="text-gray-900 font-medium uppercase tracking-wider text-sm">Frequently Asked Questions</span>
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Find answers to common questions about our auto AC services, including service duration, mobile repairs, maintenance schedules, and more.
          </p>
        </div>
          ...
          <Accordion type="single" collapsible defaultValue="" className="space-y-4">
            {filteredFaqs.map((faq, index) => (
              <motion.div key={index} variants={itemVariants}>
                ...
                >
                  <AccordionTrigger 
                    className="px-6 py-4 hover:no-underline hover:bg-gray-50 text-left font-semibold text-gray-900 flex items-center justify-between group data-[state=open]:bg-gray-50"
                  >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://wa.me/YOUR_WHATSAPP_NUMBER" target="_blank" rel="noopener noreferrer">
                  <Button variant="default" className="bg-[#25D366] text-white hover:bg-[#1DA851] gap-2">
