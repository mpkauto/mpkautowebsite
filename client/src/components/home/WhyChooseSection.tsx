  ...
  const features = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1628925367903-e33998c12090?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      link: '/about',
      stats: {
        value: '15+',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1584934542987-c805f7c03449?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1584213267914-b69be9266d58?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      link: '/pricing',
      stats: {
        value: '100%',
        label: 'Satisfaction',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1594101724748-c32a81ab5960?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      <div className="container mx-auto max-w-7xl">
        <ScrollAnimation variant="fadeUp" className="text-center mb-12" duration={0.6}>
          ...
          <p className="text-base text-brand-contrastText leading-relaxed max-w-2xl mx-auto mb-6">
            Experience premium auto AC service backed by years of expertise and thousands of
            satisfied customers.
          </p>
        </ScrollAnimation>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-20 p-6 flex flex-col h-full">
                <div className="mb-4 bg-white/10 p-3 rounded-lg inline-block">{feature.icon}</div>
                <h3 className="text-2xl font-medium text-white mb-6">{feature.title}</h3>
                <p className="text-base text-brand-contrastText mb-6 flex-grow">
                  {feature.description}
                </p>
                <div
                  className={`${feature.stats.color} px-4 py-2 rounded-lg inline-flex items-center gap-2 mb-4`}
                >
