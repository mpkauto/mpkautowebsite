  ...
  const testimonials = [
    {
      rating: 5,
      comment:
        'MPK fixed my AC in less than two hours. Great service and fair pricing! Will definitely return for future services.',
      name: 'Michael R.',
    ...
    },
    {
      rating: 5,
      comment:
        "As a rideshare driver, a functioning AC is essential. MPK's quick service and mobile option saved me from losing work days.",
      name: 'Sarah L.',
      title: 'Uber Driver',
      image:
    ...
    },
    {
      rating: 4.5,
      comment:
        'The diagnostic service was thorough and they explained everything clearly. No pushy upselling like other places.',
      name: 'David K.',
    ...
    },
    {
      rating: 5,
      comment:
        "I was impressed by how quickly they diagnosed the issue with my car's AC. Professional service from start to finish.",
      name: 'Jennifer M.',
    ...
    },
    {
      rating: 4.5,
      comment:
        'The team at MPK went above and beyond to fix my complicated AC issue. They even stayed late to finish the job.',
      name: 'Robert T.',
          ...
          <ScrollAnimation variant="fadeUp">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-[#D4D4D4] font-medium uppercase tracking-wider text-sm">
                  Testimonials
                </span>
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Read testimonials from our satisfied customers who trust us with their vehicle's
                comfort.
              </p>
            </div>
          </ScrollAnimation>
                    ...
                    <swiper-slide key={index}>
                      ...
                      >
                        ...
                        <div className="text-center mb-6">
                          ...
                          <span className="ml-2 text-sm text-[#F2F4F8]/80 font-medium">
                            {testimonial.rating}
                          </span>
                        </div>

                        {/* Testimonial text */}
                        <p className="text-[#F2F4F8]/90 mb-6 text-lg italic leading-relaxed">
                          {testimonial.comment}
                        </p>
