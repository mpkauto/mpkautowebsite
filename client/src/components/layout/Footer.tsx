      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-7xl relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 md:gap-x-8 mb-16">
            {/* Brand Column */}
            <ScrollAnimation variant="fadeUp" className="md:col-span-12" delay={0.1}>
              ...
              <p className="text-base text-gray-300 mb-6 max-w-sm">
                Your trusted partner for all automotive air conditioning needs. We ensure your
                comfort on the road.
              </p>
              ...
              <div className="flex space-x-4 mb-8">
                <a
                  href="#"
                  className="text-gray-300 hover:text-brand-accent p-2 bg-gray-800 rounded-full transition-all duration-300 hover:scale-110"
                  aria-label="Facebook"
                >
            ...
            <div className="border-t border-white/10 py-8 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a
                  ...
                  className="flex items-center gap-3 text-base text-gray-300 hover:text-brand-accent transition-colors duration-300 group"
                >
                  ...
                  <span>
                    No:112, Metro Star City, 1st Main Road, Manikandan Nagar, Kundratur, Chennai -
                    69
                  </span>
                </a>
                <a
                  href="tel:+917338838287"
                  className="flex items-center gap-3 text-base text-gray-300 hover:text-brand-accent transition-colors duration-300 group"
                >
                  <div className="p-2 bg-white/5 rounded-lg group-hover:bg-white/10 transition-colors duration-300">
                ...
                <a
                  href="mailto:service@mpkauto.com"
                  className="flex items-center gap-3 text-base text-gray-300 hover:text-brand-accent transition-colors duration-300 group"
                >
                  <div className="p-2 bg-white/5 rounded-lg group-hover:bg-white/10 transition-colors duration-300">
