    ...
    >
      <div className="container mx-auto px-4 max-w-screen-xl">
        <div className="flex items-center justify-between md:justify-start">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center justify-center flex-1 mx-4" aria-label="Main navigation">
          ...
          <div className="md:hidden ml-auto">
            <Sheet>
              ...
              <SheetContent side="right" className="w-[80vw] sm:w-[350px] transition-all duration-300">
                <SheetHeader>
