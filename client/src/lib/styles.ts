...
export const cardStyles = {
  ...
  interactive: "cursor-pointer transform transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1",
...
export const formStyles = {
  input: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300",
