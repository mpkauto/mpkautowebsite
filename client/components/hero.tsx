...
export function Hero() {
  return (
    <section
      className="relative h-[90vh] bg-cover bg-center flex justify-center items-center text-center"
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 w-full">
        ...
        >
          ...
          >
            <a
              href="#booking"
              className="inline-flex items-center px-6 py-3 bg-white text-black font-semibold rounded-md shadow hover:bg-gray-100 h-12 hover:scale-[1.03] transition-transform"
            >
              Book a Service
            </a>
